// obj_hallway_computer_2 — Draw GUI Event
...
// ── Sprite sizing ─────────────────────────────────────────────────────────────
var _sw = sprite_get_width(spr_hallway_computer_2);
var _sh = sprite_get_height(spr_hallway_computer_2);
var _max_spr_h = 210;
...
// ── Text metrics ──────────────────────────────────────────────────────────────
var _cap_str  = "Another terminal, still running.";
...
var _spr_draw_x = _spr_cx - _sw * _scale * 0.5 + sprite_get_xoffset(spr_hallway_computer_2) * _scale;
var _spr_draw_y = _spr_cy - _sh * _scale * 0.5 + sprite_get_yoffset(spr_hallway_computer_2) * _scale;
draw_sprite_ext(spr_hallway_computer_2, 0, _spr_draw_x, _spr_draw_y, _scale, _scale, 0, c_white, 1);
