// --- Draw GUI Event for obj_vigenere_complete ---
...
switch (phase) {
    ...
    case "title":
        ...
        draw_text(cx, 130, "Vigenere Cipher Module Cleared!");
        ...
        draw_text(cx, 180, "You have mastered the Vigenere shifting matrix.");
        draw_text(cx, 200, "The secure keyword protocol has been breached.");
    ...
    case "unlock":
        ...
        // Title
        draw_set_color(c_lime);
        draw_text_transformed(cx, 90, "ALL MODULES COMPLETE", unlock_scale, unlock_scale, 0);
        ...
        // Module name
        draw_set_color(c_yellow);
        draw_text_transformed(cx, 150, "AGENT STATUS: EXPERT", unlock_scale, unlock_scale, 0);

        // Description
        if (phase_timer > 30) {
            draw_set_color(make_color_rgb(180, 200, 220));
            draw_text(cx, 195, "You are now fully trained in classical cryptography.");
            draw_text(cx, 215, "Excellent work, Jack.");
        }
